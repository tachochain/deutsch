...
export default function Home() {
  const [token, setToken] = useState("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");
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>ELNAMAKI DEUTSCH</title>
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>
          Ich sehe auf dem <span className={styles.titleColor}>Bild </span>
        </h1>
